...
avg_spot_rate = shipment_data_entity_type.create_feature(
        ...
        value_type="DOUBLE", # BOOL, BOOL_ARRAY, DOUBLE, DOUBLE_ARRAY, INT64, INT64_ARRAY, STRING, STRING_ARRAY, BYTES.
...
df_float['update_time'] =feature_time.astype("datetime64[ns]")


# add shipment_data_id field. GCP wants it to be in STRING
df_float['shipment_data_id'] = range(0, df_float.shape[0])
df_float['shipment_data_id'] = 'shipment_data_id_' + df['shipment_data_id'].astype(str)
